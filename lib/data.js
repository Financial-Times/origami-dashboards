...
function refresh() {
	...
	apis.registry.listModules().then(modules => {
		...
		directly(maxConcurrency, batch)
			.then(() => {
				metrics.modulesUpdatedCount = data.modulesUpdatedCount = rollups.modulesUpdated.size;
				metrics.contributorsCount = data.contributorsCount = rollups.contributors.size;
				metrics.issuesOpenedCount = data.issuesOpenedCount = rollups.issuesOpenedCount;
				metrics.issuesClosedCount = data.issuesClosedCount = rollups.issuesClosedCount;
				metrics.issuesCount = data.issuesCount = rollups.issuesCount;
